    ...
    <div id="app">
        ...
        <div class="page-header header-filter" data-parallax="true" 
            ...
            <div class="container-fluid" style="margin-top: 100px;">
                <div class="row">
                    <div class="col-md-5">
                        <h1 class="page-header-title title">{!! $infos[0]->mainTitleCard->title !!}</h1>
                        <h4>{!! $infos[0]->mainTitleCard->main_description !!}</h4>
                    </div>
                    <div class="col-md-7">
                        <!-- Carousel Card -->
                                    ...
                                    <div class="col-md-12 text-center">
                                        <div class="card card-blog">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <h5 class="blue-text pb-2"><strong>{!! $infocard->alt_name !!}</strong></h5>
                                            </div>

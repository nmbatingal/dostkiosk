        ...
        <div class="container-fluid pt-5">
            <div class="row">
                <div class="col-md-3 ml-auto">
                    <h1 class="page-header-title title">Regional Invention Contest and Exhibits</h1>
                    <h3 class="page-header-title title">RICE</h3>
                ...
                <div class="col-md-8 mr-auto ">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <div class="wrapper">
                                <img class="" src="{{ asset('storage/gallery/health/rice/NICE 2018 2.JPG') }}" width="80%">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-center p-0" style="margin-top: -50px;">
                        <div class="alert alert-success">
                            <div class="container">
                                <h2 class="title text-white">Regional Invention Contest and Exhibits</h2>
                            </div>
                        </div>
                    </div>
                </div>

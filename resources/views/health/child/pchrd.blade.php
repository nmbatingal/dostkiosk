        ...
        <div class="container-fluid pt-5">
            <div class="row">
                <div class="col-md-3 ml-auto">
                    <h1 class="page-header-title title">Department of Science and Technology-Philippine Council for Health Research and Development</h1>
                    <h3 class="page-header-title title">DOST-PCHRD</h3>
                    <img
                        class="pl-3"
                        src="{{ asset('storage/gallery/health/pchrd/PCHRD Website QR Code.png') }}" 
                        width="120" >
                </div>
                        ...
                        <div class="col-md-12 text-center">
                            <div class="wrapper">
                                <video id="video-player" 
                                       ...
                                       poster="{{ asset('storage/gallery/health/pchrd/video/DOSTv Episode 573 – Interview- PNHRS Week.png') }}"
                                       style="height: 100%;">

                                    <source src="{{ asset('storage/gallery/health/pchrd/video/DOSTv Episode 573 – Interview- PNHRS Week.mp4') }}" data-playlist-thumbnail="{{ asset('storage/gallery/health/pchrd/video/DOSTv Episode 573 – Interview- PNHRS Week.png') }}"
                ...
                <div class="row">
                    <div class="col-md-12 text-center p-0" style="margin-top: -50px;">
                        <div class="alert alert-success">
                            <div class="container">
                                <h2 class="title text-white">Department of Science and Technology-Philippine Council for Health Research and Development</h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab-pane active show" id="info-2">
                                <div class="row">
                                    <div class="col-md-9 ml-auto mr-auto">
                                        <h3 class="title">About DOST-PCHRD</h3>

                                        <img class="pl-3" src="{{ asset('storage/gallery/health/pchrd/PCHRD-Logo.jpg') }}" width="250" >

        ...
        <div class="container-fluid pt-5">
            <div class="row">
                <div class="col-md-3 ml-auto">
                    <h1 class="page-header-title title">Food Safety Campaign</h1>
                    <h3 class="page-header-title title">Food Safety Campaign</h3>
                </div>
                <div class="col-md-8 mr-auto ">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <div class="wrapper">
                                <img class="img-fluid" src="{{ asset('storage/gallery/health/foodsafety/Food Safety Cover Photo.JPG') }}" >
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-center p-0" style="margin-top: -50px;">
                        <div class="alert alert-success">
                            <div class="container">
                                <h2 class="title text-white">Food Safety Campaign</h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab-pane active show" id="info-2">
                                <div class="row">
                                    <div class="col-md-9 ml-auto mr-auto">
                                        <h3 class="title">About Food Safety Campaign</h3>

                                        <img class="pl-3" src="{{ asset('storage/gallery/health/feigs/FEIGS logo.jpg') }}" width="250" >

                                        <h3>As an advocate of food safety, the department commits itself to assuring safe and quality food products, responsible enterprise image and consumer protection from food-borne illnesses of the products of MSMEs from the food industry. Through our pool of experts from the Caraga Food Safety Team, the department provides consultancies and trainings on Food Safety Awareness, Good Manufacturing Practices, Hazard Analysis of Critical Control Points (HACCP), ISO 22000 Food Safety Management System, and conservation of high value products.</h3>

                                        <h3>Following the partnership with Winrock International-Philippine Cold Chain Project for Food Safety Campaign in 2016, the department has been continuously conducting Food Safety Awareness Trainings and Training of Trainers to different sectors in the region.</h3>

                                        <h3>You can check out here on how to keep your food safe. Browse through some reading materials provided by the Caraga Food Safety Team on the introduction to food safety.</h3>

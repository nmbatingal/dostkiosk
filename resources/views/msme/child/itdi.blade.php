        ...
        <div class="container-fluid pt-5">
            <div class="row">
                <div class="col-md-3 ml-auto">
                    <h1 class="page-header-title title">Department of Science and Technology-Industrial Technology Development Institute</h1>
                    <h3 class="page-header-title title">DOST-ITDI</h3>
                    <img
                        class="pl-3"
                        src="{{ asset('storage/gallery/msme/itdi/ITDI Website QR Code.png') }}" 
                        width="120" >
                </div>
                        ...
                        <div class="col-md-12 text-center">
                            <div class="wrapper">
                                <video id="video-player" 
                                       ...
                                       poster="{{ asset('storage/gallery/msme/itdi/video/ITDI-DOST TECHNOLOGY OFFERING Featuring ADVANCED TECHNOLOGIES.png') }}"
                                       style="height: 100%;">

                                    <source src="{{ asset('storage/gallery/msme/itdi/video/ITDI-DOST TECHNOLOGY OFFERING Featuring ADVANCED TECHNOLOGIES.mp4') }}" data-playlist-thumbnail="{{ asset('storage/gallery/msme/itdi/video/ITDI-DOST TECHNOLOGY OFFERING Featuring ADVANCED TECHNOLOGIES.png') }}"
                ...
                <div class="row">
                    <div class="col-md-12 text-center p-0" style="margin-top: -50px;">
                        <div class="alert alert-success">
                            <div class="container">
                                <h2 class="title text-white">Department of Science and Technology-Industrial Technology Development Institute</h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab-pane active show" id="info-2">
                                <div class="row">
                                    <div class="col-md-9 ml-auto mr-auto">
                                        <h3 class="title">About DOST-ITDI</h3>

                                        <img class="pl-3" src="{{ asset('storage/gallery/msme/itdi/ITDI Logo.png') }}" width="150" >

                                        <h3>Want new product ideas? Watch the how-to videos of research-based products developed by ITDI like Calamansi concentrate, Charcoal briquettes, Herbal Guyabano, and more. ITDI features the technology behind disaster-resilient and ready-to-eat foods like arroz caldo, smoked fish rice meal, Cassava in light syrup, Boiled Sweet Potato, and Monay. Learn more about the Food Innovation Centers nationwide and their featured technologies like the Vacuum Fryer, Water Retort, and Cabinet Dryer.</h3>

                                        <br>
                                        <h3 class="title">More on DOST-ITDI</h3>
                                        <iframe src="http://www.itdi.dost.gov.ph/" id="target-div" frameborder="0" width="100%" height="980px"></iframe>
                                    </div>
                                </div>
                            </div>

                            ...
                            <div class="tab-pane active show" id="info-2">
                                <div class="row">
                                    <div class="col-md-9 ml-auto mr-auto">
                                        ...
                                        <h3>It has always been a challenge of the MSMEs in the regions—to transform locally-produced goods into globally competitive products. Hence, DOST developed the Packaging and Labeling Program for our Micro, Small and Medium Enterprises.</h3>

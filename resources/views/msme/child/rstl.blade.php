        ...
        <div class="container-fluid pt-5">
            <div class="row">
                <div class="col-md-3 ml-auto">
                    <h1 class="page-header-title title">Department of Science and Technology-Regional Standards and Testing Laboratory</h1>
                    <h3 class="page-header-title title">DOST-RSTL</h3>
                </div>
                        ...
                        <div class="col-md-12 text-center">
                            <div class="wrapper">
                                <video id="video-player" 
                                       ...
                                       poster="{{ asset('storage/gallery/msme/rstl/video/Caraga RSTL.png') }}"
                                       style="height: 100%;">

                                    <source src="{{ asset('storage/gallery/msme/rstl/video/Caraga RSTL.mp4') }}" data-playlist-thumbnail="{{ asset('storage/gallery/msme/rstl/video/Caraga RSTL.png') }}"
                ...
                <div class="row">
                    <div class="col-md-12 text-center p-0" style="margin-top: -50px;">
                        <div class="alert alert-success">
                            <div class="container">
                                <h2 class="title text-white">Department of Science and Technology-Regional Standards and Testing Laboratory</h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab-pane active show" id="info-2">
                                <div class="row">
                                    <div class="col-md-9 ml-auto mr-auto">
                                        <h3 class="title">About DOST-RSTL</h3>

                                        <h3>For eighteen years, the <b class="font-bold">Regional Standards and Testing Laboratory</b> dedicates itself in serving testing and analytical services, ensuring that products and services of various industries in Caraga Region maintain its quality and meet international standards.</h3>

                                        <h3>More than its services, the Regional Standards and Testing Laboratory also ensures its quality service to clients through its accreditations from the Food and Drug Administration, DOH and DENR-EMB, while consistently upholding its ISO 17025 accreditation since 2014.</h3>

                                        <h3>In 2017, the RSTL has served a total of 3,419 clients and assisted a total of 444 micro, small, medium and large enterprises from its three main laboratories—the microbiological laboratory, physical and chemical laboratory, and the metrology laboratory. Through its testing services, the lab was able to increase its income to 2,507,947.40.</h3>
                                    </div>
                                </div>
                            </div>

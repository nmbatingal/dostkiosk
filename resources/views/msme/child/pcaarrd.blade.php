        ...
        <div class="container-fluid pt-5">
            <div class="row">
                <div class="col-md-3 ml-auto">
                    <h1 class="page-header-title title">Department of Science and Technology-Philippine Council for Agriculture, Aquatic and Natural Resources Research and Development</h1>
                    <h3 class="page-header-title title">DOST-PCAARRD</h3>
                    <img
                        class="pl-3"
                        src="{{ asset('storage/gallery/msme/pcaarrd/PCAARRD Website QR Code.png') }}" 
                        width="120" >
                </div>
                        ...
                        <div class="col-md-12 text-center">
                            <div class="wrapper">
                                <video id="video-player" 
                                       ...
                                       poster="{{ asset('storage/gallery/msme/pcaarrd/video/Coral Restoration Proj.png') }}"
                                       style="height: 100%;">

                                    <source src="{{ asset('storage/gallery/msme/pcaarrd/video/Coral Restoration Proj.mp4') }}" data-playlist-thumbnail="{{ asset('storage/gallery/msme/pcaarrd/video/Coral Restoration Proj.png') }}"
                ...
                <div class="row">
                    <div class="col-md-12 text-center p-0" style="margin-top: -50px;">
                        <div class="alert alert-success">
                            <div class="container">
                                <h2 class="title text-white">Department of Science and Technology-Philippine Council for Agriculture, Aquatic and Natural Resources Research and Development</h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab-pane active show" id="info-2">
                                <div class="row">
                                    <div class="col-md-9 ml-auto mr-auto">
                                        <h3 class="title">About DOST-PCAARRD</h3>

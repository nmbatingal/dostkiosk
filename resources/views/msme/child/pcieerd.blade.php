        ...
        <div class="container-fluid pt-5">
            <div class="row">
                <div class="col-md-3 ml-auto">
                    <h1 class="page-header-title title">Department of Science and Technology-Philippine Council for Industry, Energy, and Emerging Technology Research and Development</h1>
                    <h3 class="page-header-title title">DOST-PCIEERD</h3>
                    <img
                        class="pl-3"
                        src="{{ asset('storage/gallery/msme/pcieerd/DOST PCIEERD Website QR Code.png') }}" 
                        width="120" >
                </div>
                        ...
                        <div class="col-md-12 text-center">
                            <div class="wrapper">
                                <video id="video-player" 
                                       ...
                                       poster="{{ asset('storage/gallery/msme/pcieerd/video/DOST PCIEERD Animated Video.png') }}"
                                       style="height: 100%;">

                                    <source src="{{ asset('storage/gallery/msme/pcieerd/video/DOST PCIEERD Animated Video.mp4') }}" data-playlist-thumbnail="{{ asset('storage/gallery/msme/pcieerd/video/DOST PCIEERD Animated Video.png') }}"
                ...
                <div class="row">
                    <div class="col-md-12 text-center p-0" style="margin-top: -50px;">
                        <div class="alert alert-success">
                            <div class="container">
                                <h2 class="title text-white">Department of Science and Technology-Philippine Council for Industry, Energy, and Emerging Technology Research and Development</h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab-pane active show" id="info-2">
                                <div class="row">
                                    <div class="col-md-9 ml-auto mr-auto">
                                        <h3 class="title">About DOST-PCIEERD</h3>

                                        <img class="pl-3" src="{{ asset('storage/gallery/msme/pcieerd/PCIEERD-logo.jpg') }}" width="150" >

                                        <h3>The Philippine Council for Agriculture, Aquatic and Natural Resources Research and Development (PCAARRD) is one of the sectoral councils under the Department of Science and Technology (DOST). PCAARRD formulate policies, plans, projects, and strategies for S&T development in the agriculture, forestry, aquatic and natural resources sectors, creates program and allocates government and external funds generated for R&D efforts, monitors research and development (R&D) projects, and generates external funds for its R&D activities. Check out their booth for their featured technologies: Native chicken, Itik Pinas, Carageenan Plant Growth Enhancer for Mungbean, and root trainer.</h3>
                                    </div>
                                </div>
                            </div>
